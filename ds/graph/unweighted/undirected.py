...
class Graph:
    ...
    def build_graph(self, connections: List[Tuple[int, int]]) -> List[Vertex]:
        vertices = None
        max_value = 0
        ...
        for connection in connections:
            ...
            vertices[connection[0]].edges.append(Edge(vertices[connection[0]], vertices[connection[1]]))
            vertices[connection[1]].edges.append(Edge(vertices[connection[1]], vertices[connection[0]]))
